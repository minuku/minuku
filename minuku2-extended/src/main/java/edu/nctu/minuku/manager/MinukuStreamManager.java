...
import edu.nctu.minuku.model.MinukuStreamSnapshot;
...
import edu.nctu.minukucore.manager.StreamManager;
...
import edu.nctu.minukucore.streamgenerator.StreamGenerator;
...
public class MinukuStreamManager implements StreamManager {
    ...
    public void setT(Class<? extends DataRecord> datarecord, Stream stream){
