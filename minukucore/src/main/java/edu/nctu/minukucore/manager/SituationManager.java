...
package edu.nctu.minukucore.manager;

import edu.nctu.minukucore.event.IsDataExpectedEvent;
import edu.nctu.minukucore.event.NoDataChangeEvent;
import edu.nctu.minukucore.event.StateChangeEvent;
 ...
 * A registry of all the {@link edu.nctu.minukucore.situation.Situation} situations
...
public interface SituationManager {
    ...
    /**
     * Called by {@link edu.nctu.minukucore.manager.StreamManager}.
     * Sends request to appropriate situations
     * Note: does not subscribe to any event on the event bus
     * @param s {@link edu.nctu.minukucore.model.StreamSnapshot}
     ...
     * {@link edu.nctu.minukucore.model.DataRecord} entry is expected.
     ...
     *      {@link edu.nctu.minukucore.model.DataRecord}s that the Situation depends on
