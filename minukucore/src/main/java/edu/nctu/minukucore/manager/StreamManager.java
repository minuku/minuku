 ...
 * @see edu.nctu.minukucore.stream.Stream
 * @version 1.0
 */
public interface StreamManager {
     ...
     * @return a list of Stream class instances {@link edu.nctu.minukucore.stream.Stream}
     */
     ...
     * @param <T> the application specific DataRecord {@link edu.nctu.minukucore.model.DataRecord}
     * @throws StreamNotFoundException {@link edu.nctu.minukucore.exception.StreamNotFoundException}
     * @throws StreamAlreadyExistsException {@link edu.nctu.minukucore.exception.StreamAlreadyExistsException}
     */
     ...
     * {@link edu.nctu.minukucore.streamgenerator.StreamGenerator}
     * Subscribes to the state change event
     * {@link edu.nctu.minukucore.event.StateChangeEvent}
     * This method then calls the state change handler of the SituationManager
     * {@link edu.nctu.minukucore.manager.SituationManager}
     */
    @Subscribe
