...
package edu.nctu.minukucore.situation;
...
public interface Situation {
     ...
     *                 {@link edu.nctu.minukucore.model.StreamSnapshot}
     * @param <T>      the application specific DataRecord
     *                 {@link edu.nctu.minukucore.model.DataRecord}
     * @return         an {@link edu.nctu.minukucore.event.ActionEvent}
     *                 some {@link edu.nctu.minukucore.action.Action} will be
     ...
     * @throws {@link edu.nctu.minukucore.exception.DataRecordTypeNotFound}
     */
