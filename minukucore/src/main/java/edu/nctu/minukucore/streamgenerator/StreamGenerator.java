...
package edu.nctu.minukucore.streamgenerator;
...
public interface StreamGenerator<T extends DataRecord> {
     ...
     * @see edu.nctu.minukucore.manager.StreamManager
     */
     ...
     * @throws edu.nctu.minukucore.exception.StreamNotFoundException
     */
     ...
     * {@link edu.nctu.minukucore.manager.StreamManager},
